...
textBox.pack()
buttonCommit=tkinter.Button(root, height=1, width=10, text="Input Color", command=lambda: function(c))
buttonCommit.pack()

b = tkinter.Button(root, text='Draw a circle', width=10, bg='red', fg='white', command=lambda: function(c))
b.pack()
